...
/**
 * ImageDeletePageParameters Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ImageDeletePageParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageDeletePageParameters';
     ...
     * Sets file_id
     *
     * @param string $file_id The identifier of the previously uploaded image to be processed.
     *
     * @return $this
     */
     ...
     * Sets page_range
     *
     * @param string $page_range Specifies the number of the page, or the range of pages to be deleted.
     *
     * @return $this
     */
