...
/**
 * PdfInsertImageParameters Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PdfInsertImageParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PdfInsertImageParameters';
     ...
     * Sets page_range
     *
     * @param string $page_range Specifies the page or the range of pages where the image shall be inserted.
     *
     * @return $this
     */
     ...
     * Sets image_data
     *
     * @param string|null $image_data Specifies the data of the image to be inserted.
     *
     * @return $this
     */
