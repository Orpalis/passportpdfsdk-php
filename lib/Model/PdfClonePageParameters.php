...
/**
 * PdfClonePageParameters Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PdfClonePageParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PdfClonePageParameters';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['source_file_id'] === null) {
            $invalidProperties[] = "'source_file_id' can't be null";
        }
     ...
     * Sets source_file_id
     *
     * @param string $source_file_id Specifies the file identifier of the PDF to be cloned.
     *
     * @return $this
     */
     ...
     * Sets page_range
     *
     * @param string $page_range Specifies the number of the page, or the range of pages to be cloned.
     *
     * @return $this
     */
     ...
     *
     * @param int $destination_page Specifies the number of the page where the cloned page(s) shall be inserted.
     *
     * @return $this
     */
