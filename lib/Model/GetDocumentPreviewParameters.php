...
/**
 * GetDocumentPreviewParameters Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class GetDocumentPreviewParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetDocumentPreviewParameters';
     ...
     *
     * @param int|null $thumbnail_width Specifies, in pixels, the width of the thumbnail to be retrieved.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $thumbnail_height Specifies, in pixels, the height of the thumbnail to be retrieved.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $thumbnail_background_color Specifies the background color of the thumbnail, using the color name (ie: \"red\") or its RGBa code (ie: \"rgba(255,0,0,1)\").
     *
     * @return $this
     */
