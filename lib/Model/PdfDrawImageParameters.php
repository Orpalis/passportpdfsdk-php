...
/**
 * PdfDrawImageParameters Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PdfDrawImageParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PdfDrawImageParameters';
    ...
    protected static $openAPITypes = [
        ...
        'bitonal_compression' => '\OpenAPI\Client\Model\PdfImageCompressionScheme',
        'image_layout' => '\OpenAPI\Client\Model\DrawableContentLayoutParameters'
    ];
    ...
    protected static $setters = [
        ...
        'image_file_id' => 'setImageFileId',
        'quality' => 'setQuality',
        'color_image_compression' => 'setColorImageCompression',
        'bitonal_compression' => 'setBitonalCompression',
        'image_layout' => 'setImageLayout'
    ];
    ...
    protected static $getters = [
        ...
        'image_file_id' => 'getImageFileId',
        'quality' => 'getQuality',
        'color_image_compression' => 'getColorImageCompression',
        'bitonal_compression' => 'getBitonalCompression',
        'image_layout' => 'getImageLayout'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['image_file_id'] = isset($data['image_file_id']) ? $data['image_file_id'] : '';
        ...
        $this->container['bitonal_compression'] = isset($data['bitonal_compression']) ? $data['bitonal_compression'] : null;
        $this->container['image_layout'] = isset($data['image_layout']) ? $data['image_layout'] : null;
    }
     ...
     * Sets page_range
     *
     * @param string $page_range Specifies the page or the page range on which the image shall be drawn.
     *
     * @return $this
     */
     ...
     * Sets image_data
     *
     * @param string|null $image_data Specifies the data of the image to be drawn.
     *
     * @return $this
     */
     ...
     * Sets image_file_id
     *
     * @param string|null $image_file_id Specifies the file ID of the image to be drawn.
     *
     * @return $this
     */
     ...
     * Sets quality
     *
     * @param int|null $quality Specifies the level of quality to be used for the compression, from 1 (poorest) to 100 (greatest).
     *
     * @return $this
     */
    ...
    /**
     * Gets bitonal_compression
     *
     * @return \OpenAPI\Client\Model\PdfImageCompressionScheme|null
     */
    public function getBitonalCompression()
    {
        return $this->container['bitonal_compression'];
    }

    /**
     * Sets bitonal_compression
     *
     * @param \OpenAPI\Client\Model\PdfImageCompressionScheme|null $bitonal_compression bitonal_compression
     *
     * @return $this
     */
    public function setBitonalCompression($bitonal_compression)
    {
        $this->container['bitonal_compression'] = $bitonal_compression;
    ...
    {
        return $this->container['image_layout'];
    }

    /**
     * Sets image_layout
     *
     * @param \OpenAPI\Client\Model\DrawableContentLayoutParameters|null $image_layout image_layout
     *
     * @return $this
     */
    public function setImageLayout($image_layout)
    {
        $this->container['image_layout'] = $image_layout;
