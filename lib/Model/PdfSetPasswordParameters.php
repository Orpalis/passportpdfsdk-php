...
/**
 * PdfSetPasswordParameters Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PdfSetPasswordParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PdfSetPasswordParameters';
     ...
     * Sets password
     *
     * @param string $password Specifies the password to be used to open the PDF. It can be the user or the owner password.
     *
     * @return $this
     */
