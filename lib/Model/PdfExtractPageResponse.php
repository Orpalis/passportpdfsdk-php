...
/**
 * PdfExtractPageResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PdfExtractPageResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PdfExtractPageResponse';
     ...
     * Sets file_ids
     *
     * @param string[]|null $file_ids Specifies the identifier(s) of the file(s) created as a result of the action.
     *
     * @return $this
     */
     ...
     * Sets file_data
     *
     * @param string[]|null $file_data Specifies the data of the file(s) created as a result of the action.
     *
     * @return $this
     */
