...
/**
 * DocumentGetPreviewResponse Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class DocumentGetPreviewResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentGetPreviewResponse';
     ...
     * Sets page_count
     *
     * @param int|null $page_count Specifies the page count of the document.
     *
     * @return $this
     */
     ...
     * Sets thumbnail_data
     *
     * @param string|null $thumbnail_data Specifies the data of a thumbnail from the first page of the document, in PNG format.
     *
     * @return $this
     */
